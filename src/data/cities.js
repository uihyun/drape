...
export const CITIES = [
  ...
  { id: 'sanjose-us',        country: 'US', names: { en: 'San Jose',       ko: '새너제이',    ja: 'サンノゼ' } },
  { id: 'jerseycity-us',     country: 'US', names: { en: 'Jersey City',    ko: '저지시티',    ja: 'ジャージーシティ' } },
  { id: 'hoboken-us',        country: 'US', names: { en: 'Hoboken',        ko: '호보컨',      ja: 'ホーボーケン' } },
  { id: 'newark-us',         country: 'US', names: { en: 'Newark',         ko: '뉴어크',      ja: 'ニューアーク' } },
  { id: 'sanantonio-us',     country: 'US', names: { en: 'San Antonio',    ko: '샌안토니오',  ja: 'サンアントニオ' } },
  { id: 'charlotte-us',      country: 'US', names: { en: 'Charlotte',      ko: '샬럿',        ja: 'シャーロット' } },
  { id: 'columbus-us',       country: 'US', names: { en: 'Columbus',       ko: '콜럼버스',    ja: 'コロンバス' } },
  { id: 'indianapolis-us',   country: 'US', names: { en: 'Indianapolis',   ko: '인디애나폴리스', ja: 'インディアナポリス' } },
  { id: 'jacksonville-us',   country: 'US', names: { en: 'Jacksonville',   ko: '잭슨빌',      ja: 'ジャクソンビル' } },
  { id: 'kansascity-us',     country: 'US', names: { en: 'Kansas City',    ko: '캔자스시티',  ja: 'カンザスシティ' } },
  { id: 'neworleans-us',     country: 'US', names: { en: 'New Orleans',    ko: '뉴올리언스',  ja: 'ニューオーリンズ' } },
  { id: 'raleigh-us',        country: 'US', names: { en: 'Raleigh',        ko: '롤리',        ja: 'ローリー' } },
  { id: 'pittsburgh-us',     country: 'US', names: { en: 'Pittsburgh',     ko: '피츠버그',    ja: 'ピッツバーグ' } },
  { id: 'saltlakecity-us',   country: 'US', names: { en: 'Salt Lake City', ko: '솔트레이크시티', ja: 'ソルトレイクシティ' } },
  { id: 'tampa-us',          country: 'US', names: { en: 'Tampa',          ko: '탬파',        ja: 'タンパ' } },
  { id: 'orlando-us',        country: 'US', names: { en: 'Orlando',        ko: '올랜도',      ja: 'オーランド' } },
  { id: 'sacramento-us',     country: 'US', names: { en: 'Sacramento',     ko: '새크라멘토',  ja: 'サクラメント' } },
  { id: 'oakland-us',        country: 'US', names: { en: 'Oakland',        ko: '오클랜드',    ja: 'オークランド' } },
  { id: 'baltimore-us',      country: 'US', names: { en: 'Baltimore',      ko: '볼티모어',    ja: 'ボルティモア' } },
  { id: 'memphis-us',        country: 'US', names: { en: 'Memphis',        ko: '멤피스',      ja: 'メンフィス' } },
  { id: 'louisville-us',     country: 'US', names: { en: 'Louisville',     ko: '루이빌',      ja: 'ルイビル' } },
  { id: 'richmond-us',       country: 'US', names: { en: 'Richmond',       ko: '리치먼드',    ja: 'リッチモンド' } },
  { id: 'milwaukee-us',      country: 'US', names: { en: 'Milwaukee',      ko: '밀워키',      ja: 'ミルウォーキー' } },
  { id: 'albuquerque-us',    country: 'US', names: { en: 'Albuquerque',    ko: '앨버커키',    ja: 'アルバカーキ' } },
  { id: 'tucson-us',         country: 'US', names: { en: 'Tucson',         ko: '투손',        ja: 'ツーソン' } },
  { id: 'fresno-us',         country: 'US', names: { en: 'Fresno',         ko: '프레즈노',    ja: 'フレズノ' } },
  { id: 'longbeach-us',      country: 'US', names: { en: 'Long Beach',     ko: '롱비치',      ja: 'ロングビーチ' } },
  { id: 'detroit-us',        country: 'US', names: { en: 'Detroit',        ko: '디트로이트',  ja: 'デトロイト' } },
  { id: 'omaha-us',          country: 'US', names: { en: 'Omaha',          ko: '오마하',      ja: 'オマハ' } },
  { id: 'fortworth-us',      country: 'US', names: { en: 'Fort Worth',     ko: '포트워스',    ja: 'フォートワース' } },
  ...
  { id: 'ottawa-ca',         country: 'CA', names: { en: 'Ottawa',         ko: '오타와',      ja: 'オタワ' } },
  { id: 'edmonton-ca',       country: 'CA', names: { en: 'Edmonton',       ko: '에드먼턴',    ja: 'エドモントン' } },
  { id: 'winnipeg-ca',       country: 'CA', names: { en: 'Winnipeg',       ko: '위니펙',      ja: 'ウィニペグ' } },
  { id: 'quebec-ca',         country: 'CA', names: { en: 'Quebec City',    ko: '퀘벡시티',    ja: 'ケベックシティ' } },
