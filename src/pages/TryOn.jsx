...
// deliberately daily-only, on a FIXED 5-slot scale, so each try-on drains exactly
// 1/5 and it resets cleanly at midnight. The bonus is a persistent reserve of a
// different nature (a balance, not a daily gauge — it can reach the hundreds), so
// it lives in the +M pill, not this ring. Spend order is daily→bonus, so the ring
// fully drains 5→0 before the pill starts counting down — the two never move at
// once.
