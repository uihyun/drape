export const en = {
  ...
  fitsOutTitle: 'Out of fits',
  fitsOutBody: 'You’ve used all your fits for now. Invite friends for +10 fits each — or come back tomorrow for 5 more.',
  fitsRow: 'try-on fits',
  inviteFriends: 'Invite friends',
  inviteEarnFits: '+10 fits per friend',
  inviteEnterCode: 'Enter invite code',
  inviteCodeLabel: 'Invite code',
  inviteCodeApply: 'Apply',
  inviteYourCode: 'Your invite code',
  inviteRedeemed: 'Applied — your friend earned +10 fits. Thanks!',
  ...
  inviteShareCode: 'Get drape and enter my code {code} for 10 bonus fits.',
