export const en = {
  ...
  onboardActionBody: 'One photo does it all — today lands on your calendar, AI reads your look, and the pieces go into your closet.',
  ...
  landingHow2B: "See any piece or any member's look on your own body before you wear or buy it.",
  landingHow3T: 'Ask your stylist',
  landingHow3B: 'Four AI stylists with real opinions pull from what you already own — and tell you what to skip.',
  landingHow4T: "See what everyone's wearing",
  landingHow4B: "Trends collects the week's looks and the styles on the rise — save the ones you love, then try them on you.",
  navOutfits: 'Outfits',
  navItems: 'Items',
  ...
  fitsLeft: '{n} fits left',
  fitsBonus: '+{n} bonus',
  fitsToday: '{n} left today',
  fitsOutTitle: 'Out of try-ons',
  fitsOutBody: 'You’ve used all your try-ons for now. Invite a friend and you each get +10 — or come back tomorrow for 5 more.',
  fitsRow: 'try-on fits',
  ...
  inviteRedeemed: 'Applied — you both got +10 try-ons. Enjoy!',
  ...
  inviteShareCode: 'Get drape and enter my code {code} — we both get 10 bonus try-ons.',
  ...
  ootdPublishLabel: 'Make public',
  ootdPublishHint: 'Public looks can be featured in Trends — we hand-pick from what members share.',
  ootdNotFound: 'This OOTD is unavailable.',
  confirmDeleteGeneration: 'Delete this try-on result?',
  notifications: 'Notifications',
  notifEmpty: 'No notifications yet.',
  notifCommentedLook: 'commented on your look',
  notifCommentedBoard: 'commented on your board',
  notifFollowed: 'started following you',
  notifTriedOn: 'tried on your look',
  notifLikedLook: 'liked your look',
  notifLikedBoard: 'liked your board',
  notifModeration: 'Your look was hidden — its image was flagged as inappropriate.',
  followers: 'Followers',
  following: 'Following',
  ...
  verdictPaidNote: 'Free reads used — the next one uses 1 try-on and gives you 10.',
  verdictLeft: 'Used 1 try-on — {n} reads left.',
  verdictSignIn: 'Sign in to ask your stylist.',
  ...
  homeScreenTrends: 'Trends',
  homeScreenProfileHint: 'Open to your own closet, calendar and try-ons.',
  homeScreenTrendsHint: 'Open to Trends — this week’s styles, colors and brands.',
  homeFeedIntro: 'drape is your closet, too — track your OOTDs and try things on.',
  homeFeedIntroCta: 'Go to my profile',
  settings: 'Settings',
  signIn: 'Sign in',
  ...
  tryThisOn: 'Try on',
  originWishlist: 'In your wishlist',
  originBorrowed: "Saved from someone else's item",
  borrowedToWishlist: 'Saved to your wishlist so you can try it on',
  triedOnCount: '{count} tried this on',
  editTags: 'Edit',
  reprocess: 'Reprocess',
  ...
  pickPieceTitle: 'Which piece is this?',
  pickPieceSub: 'A few pieces share this category — pick which one this item is.',
  ...
  stylistAiNote: 'AI',
  stylistSignInBody: 'Sign in and your stylist will build looks from your own closet.',
  personaNoaTag: 'minimal & timeless',
  personaRemyTag: 'street & relaxed',
  personaSolTag: 'romantic & soft',
  personaJunoTag: 'bold & playful',
  personaNoaBio: 'I build around one excellent neutral and let everything else get out of its way.',
  personaRemyBio: 'I start at the shoes and build up. One loud thing per outfit, never two.',
  personaSolBio: 'I dress for how a fabric moves, and for the detail nobody else would bother with.',
  personaJunoBio: 'I go looking for the pieces you\'ve been ignoring and make them the whole point.',
  stylistAskPlaceholder: 'Occasion or mood (optional) — “date night”, “rainy day”…',
  ...
  stylistPaidNote: 'Free picks used — 1 try-on gets you 3 more. You have {fits}.',
  stylistNoFits: 'Out of free picks and try-ons for today — invite a friend and you each get +10, or come back tomorrow.',
  ...
  stylistChange: 'change',
  uploadPhotos: 'Upload photos',
  analyzeUploadHint2: 'One photo or up to {max} — we read each one',
  uploadSeveral: 'Upload several',
  analyzeMultiHint: 'Pick up to {max} photos — each becomes its own items',
  sortTitle: 'Sort',
  sortNewest: 'Newest',
  sortOldest: 'Oldest',
  sortBright: 'Light → dark',
  sortDark: 'Dark → light',
  sortCategory: 'By category',
  sortMostWorn: 'Most worn',
  sortLeastWorn: 'Forgotten first',
  navTrends: 'Trends',
  trendsTitle: 'Trends',
  trendsKicker: 'The week in drape',
  trendsHeadline: '{style} is having a moment.',
  trendsDataline: '{items} new pieces · {tryons} try-ons',
  trendsIssue: 'Issue of {date} · covering {from}–{to} · out every Monday',
  trendsLooks: 'Looks of the week',
  trendsLooksNote: 'Picked by drape from looks shared publicly in the app.',
  trendsBrands: 'Most-owned brands',
  trendsNew: 'NEW',
  trendsAddedThisWeek: '{n} added',
  trendsInClosets: '{n} in closets',
  trendsTopStyles: 'Styles on the rise',
  trendsTopColors: 'Colors people are wearing',
  trendsTriedOn: 'Most tried-on categories',
  trendsMarket: 'Fresh on the marketplace',
  ...
  tourTryon: 'Try-on is the reason drape exists: see any piece on your own photo, your face and body kept. 5 free every day.',
  homeFlipNote: 'Change it anytime in Settings.',
  ...
  myStyleAvoid: 'Colors to avoid',
  myStyleNote: 'Anything else',
  myStyleNotePlaceholder: '“No crop tops”, “high-waisted only”, “I run cold”…',
  ...
  hintTryonLook: 'This look can go on you — your real face and body, one tap.',
  ...
  deleteAccountItem_credits: 'Any try-ons you have left',
