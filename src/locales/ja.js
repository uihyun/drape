...
export const ja = {
  ...
  landingHow2B: 'どんなアイテムも、誰のコーデも — 着る前に自分の体で確認。',
  landingHow3T: 'スタイリストに聞く',
  landingHow3B: '個性の違うAIスタイリスト4人が、手持ちの服から選び、やめた方がいい組み合わせも教えてくれます。',
  landingHow4T: 'みんなの「今」を見る',
  landingHow4B: 'トレンドで今週のスタイルと伸びているムードをチェック。気に入った着こなしは保存して、自分の体で試着。',
  navOutfits: 'コーデ',
  navItems: 'アイテム',
  navCalendar: 'カレンダー',
  navTryOn: '試着',
  ...
  fitsBonus: 'ボーナス +{n}',
  fitsToday: '今日 残り{n}',
  fitsOutTitle: '試着を使い切りました',
  fitsOutBody: '今日の無料試着を使い切りました。友達を招待すると二人とも +10試着 — または明日また5つ補充されます。',
  fitsRow: '試着 fits',
  inviteFriends: '友達を招待',
  ...
  inviteRedeemed: '適用しました — 二人とも +10試着 を獲得しました！',
  inviteAlreadyRedeemed: 'すでに招待コードを使用しています。',
  inviteInvalidCode: 'その招待コードは無効です。',
  inviteSelf: '自分のコードは使えません。',
  inviteShareCode: 'drape を入れて私のコード {code} を入力すると、二人ともボーナス試着を10個ずつもらえるよ。',
  ...
  ootdSetRep: '表紙に設定',
  ootdRepActive: '表紙写真',
  ootdPublishLabel: '公開する',
  ootdPublishHint: '公開したルックはトレンドのコミュニティピックで紹介されることがあります。',
  ootdNotFound: 'この OOTD は表示できません。',
  confirmDeleteGeneration: 'この試着結果を削除しますか?',
  notifications: '通知',
  notifEmpty: 'まだ通知はありません。',
  notifCommentedLook: 'さんがあなたのルックにコメントしました',
  notifCommentedBoard: 'さんがあなたのボードにコメントしました',
  notifFollowed: 'さんがあなたをフォローしました',
  notifTriedOn: 'さんがあなたのルックを試着しました',
  notifLikedLook: 'さんがあなたのルックにいいねしました',
  notifLikedBoard: 'さんがあなたのボードにいいねしました',
  notifModeration: '画像が不適切と判断され、ルックの公開が取り消されました。',
  followers: 'フォロワー',
  following: 'フォロー中',
  ...
  verdictPaidNote: '本日の無料分は終了 — 次からは試着1回で10回分です。',
  verdictLeft: '試着1回を使いました — 残り{n}回です。',
  verdictSignIn: 'ログインするとスタイリストに聞けます。',
  ...
  homeScreenTrends: 'トレンド',
  homeScreenProfileHint: 'アプリを開くと自分のクローゼット・カレンダー・試着から始まります。',
  homeScreenTrendsHint: 'アプリを開くとトレンドから始まります — 今週のスタイル・カラー・ブランドを見られます。',
  homeFeedIntro: 'drapeはあなたのクローゼットでもあります — OOTDを記録して試着しましょう。',
  homeFeedIntroCta: 'マイプロフィールへ',
  settings: '設定',
  signIn: 'ログイン',
  ...
  tryThisOn: '試着する',
  originWishlist: 'ウィッシュリスト',
  originBorrowed: '他の人のアイテムから保存',
  borrowedToWishlist: '試着できるようウィッシュリストに保存しました',
  triedOnCount: '{count}人が試着しました',
  editTags: '編集',
  reprocess: '再処理',
  ...
  onboardSlide2Body: '登録した自分の写真で、どんな服でも自分に着せて試せます。実際に着なくても、似合うか、どこに着て行くといいか先に確認できます。本当の自分の顔と体型のままだから、仕上がりも自然です。1日5回まで無料で試着でき、友達を招待するともっと増えます。',
  onboardSlide3Title: '見てまわって、クローゼットを新しく',
  onboardSlide3Body: 'フィードを見てまわって、他の人の服を試着したり、コーデを分析して何の服か調べたり、気に入ったものを保存。着なくなった服はマーケットに出し、必要なものは買って、クローゼットを整理して新しくしましょう。',
  fitsBalanceLabel: '試着',
  ...
  stylistTitle: 'スタイリスト',
  stylistAiNote: 'AI',
  stylistSignInBody: 'ログインすると、あなたのクローゼットからスタイリストがルックを提案します。',
  personaNoaTag: 'ミニマル & タイムレス',
  personaRemyTag: 'ストリート & リラックス',
  personaSolTag: 'ロマンティック & ソフト',
  personaJunoTag: 'ボールド & プレイフル',
  personaNoaBio: 'いいニュートラルを一点決めて、あとは邪魔をさせません。',
  personaRemyBio: '靴から決めて積み上げます。派手なのは一着にひとつだけ。',
  personaSolBio: '生地の揺れ方と、誰も気に留めないディテールで組みます。',
  personaJunoBio: '着ていない服を掘り出して、それを主役にします。',
  stylistAskPlaceholder: 'シーンや気分（任意）—「デート」「雨の日」…',
  ...
  stylistPaidNote: '無料のおすすめを使い切りました — 試着1回で3回分。残り{fits}回です。',
  stylistNoFits: '本日の無料提案と試着を使い切りました — 友達を招待するとお互い+10回、または明日また回復します。',
  ...
  analyzeUploadHint2: '1枚でも最大{max}枚でも — それぞれ読み取ります',
  uploadSeveral: '複数枚アップロード',
  analyzeMultiHint: '最大{max}枚選択 — 写真ごとにアイテムを登録します',
  sortTitle: '並べ替え',
  sortNewest: '新しい順',
  sortOldest: '古い順',
  sortBright: '明るい色 → 暗い色',
  ...
  trendsIssue: '{date}号 · {from}〜{to}の記録 · 毎週月曜発行',
  trendsLooks: '今号のルック',
  trendsLooksNote: 'アプリで公開されたルックからdrapeが選びました。',
  trendsBrands: '所有が多いブランド',
  trendsNew: 'NEW',
  trendsAddedThisWeek: '{n}点登録',
  trendsInClosets: 'クローゼットに{n}点',
  trendsTopStyles: '人気上昇中のスタイル',
  trendsTopColors: 'みんなが着ている色',
  trendsTriedOn: 'よく試着されるカテゴリ',
  trendsMarket: 'マーケットの新着',
  trendsEmpty: 'トレンドは準備中 — アイテムを登録して試着すると、このボードが埋まっていきます。',
  tourTitle: 'drape の使い方',
  tourTrends: 'トレンドはトップ画面です — 今週伸びているスタイル・色・ブランドを、毎週月曜に新しい号でお届けします。',
  tourProfileNav: 'このボタンがあなたのクローゼットです。持っている服、カレンダー、試着がすべてここに。',
  tourTabs: 'クローゼットはこのタブに分かれています — コーデ、カレンダー、クローゼット、ボード、試着。',
  tourCreate: 'ここから始めます。服を撮ると背景を切り抜いてタグ付けまで。数着入れれば残りは全部動きます。',
  ...
  closetDensity: '表示サイズ',
  tourTryon: '試着が drape の核心です。自分の写真の上に服を着せて確認できます。顔と体はそのまま、毎日5回無料。',
  homeFlipNote: '設定でいつでも変更できます。',
  myStyleTitle: 'マイスタイル',
  myStyleHint: 'ここに書いた内容が推測より優先されます。次の提案からすぐ反映されます。',
  myStyleLiked: '好きなスタイル',
  myStyleAvoid: '避けたい色',
  myStyleNote: 'その他メモ',
  myStyleNotePlaceholder: '「クロップ丈は着ない」「ハイウエストのみ」「寒がりです」…',
  importTitle: 'リンクから取り込む',
  importLoading: 'リンクからルックを取得中…',
  importNoUrl: '共有された内容にリンクが見つかりませんでした。',
  importFailed: 'このリンクから画像を取得できませんでした。画像を保存して、ここから直接アップロードしてください。',
  ...
  hintTryonLook: 'このルック、自分の写真でそのまま試着できます。',
  ...
  deleteAccountItem_credits: '残りの試着回数',
