...
export const ja = {
  ...
  tourCreate: 'プラスからすべて始まります。服の登録、今日のコーデ、試着まで。',
  tourStylist: 'AIスタイリストはここにいます。手持ちの服だけでコーデを組みます。',
  tourSettings: '設定 — 言語、アプリが開く画面、試着用の写真を変更できます。',
  myStyleTitle: 'マイスタイル',
  ...
  stylistHint: 'NEW — AIスタイリストが登場。あなたのクローゼットから無料でコーデ提案、そのまま試着できます。',
