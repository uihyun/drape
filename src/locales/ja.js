...
export const ja = {
  ...
  trendsNew: 'NEW',
  trendsAddedThisWeek: '今週{n}点登録',
  trendsInClosets: 'クローゼットに{n}点',
  trendsTopStyles: '人気上昇中のスタイル',
  trendsTopColors: 'みんなが着ている色',
  trendsTriedOn: 'よく試着されるカテゴリ',
  trendsCommunityPicks: 'コミュニティピック',
  trendsCuratedNote: '公開設定されたルックから選んでご紹介します。ルックを公開するとトレンドに掲載されることがあります。',
  trendsMarket: 'マーケットの新着',
  trendsEmpty: 'トレンドは準備中 — アイテムを登録して試着すると、このボードが埋まっていきます。',
  myStyleTitle: 'マイスタイル',
  myStyleHint: 'スタイリストに直接伝えましょう — ここに書いた内容は、クローゼットや試着から推測した好みより常に優先されます。',
