...
export const ja = {
  ...
  fitsBonus: 'ボーナス +{n}',
  fitsToday: '今日 残り{n}',
  fitsOutTitle: 'fits を使い切りました',
  fitsOutBody: '今の fits を使い切りました。友達を招待すると1人につき +10 fits — または明日また5つ補充されます。',
  fitsRow: '試着 fits',
  inviteFriends: '友達を招待',
  inviteEarnFits: '友達1人につき +10 fits',
  inviteEnterCode: '招待コードを入力',
  inviteCodeLabel: '招待コード',
  inviteCodeApply: '適用',
  inviteYourCode: 'あなたの招待コード',
  inviteRedeemed: '適用しました — 友達が +10 fits を獲得しました。ありがとう！',
  inviteAlreadyRedeemed: 'すでに招待コードを使用しています。',
  inviteInvalidCode: 'その招待コードは無効です。',
  inviteSelf: '自分のコードは使えません。',
  inviteShareCode: 'drape を入れて私のコード {code} を入力すると、ボーナス fits が10個もらえるよ。',
