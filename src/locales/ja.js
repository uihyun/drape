...
export const ja = {
  ...
  onboardSlide2Body: '登録した自分の写真で、どんな服でも着せられます。実際に着なくても、自分に似合うか、どこに着て行くか先に確認。顔も体型も本当の自分だから、仕上がりも自然。',
  onboardSlide3Title: '見てまわって、クローゼットを新しく',
  onboardSlide3Body: 'フィードを見てまわって、他の人の服を試着したり、コーデを分析して何の服か調べたり、気に入ったものを保存。着ない服はマーケットに出し、必要なものは買って、クローゼットを整理して新しく。',
