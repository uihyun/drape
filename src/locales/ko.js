export const ko = {
  ...
  onboardActionBody: '사진 한 장이면 끝 — 오늘이 캘린더에 기록되고, AI가 착장을 분석해서 아이템까지 옷장에 담아줘요.',
  ...
  landingHow2T: '뭐든 내 몸에 가상 피팅',
  landingHow2B: '어떤 아이템이든, 누구의 착장이든 — 입기 전에 내 몸으로 먼저 봐요.',
  landingHow3T: '스타일리스트에게 물어보기',
  landingHow3B: '취향이 뚜렷한 AI 스타일리스트 넷이 이미 가진 옷으로 골라주고, 아닌 건 아니라고 말해줘요.',
  landingHow4T: '지금 다들 뭘 입는지 보기',
  landingHow4B: '트렌드에서 이번 주의 착장과 떠오르는 스타일을 확인하고, 마음에 드는 건 저장해서 내 몸에 입어봐요.',
  navOutfits: '아웃핏',
  navItems: '아이템',
  navCalendar: '캘린더',
  navTryOn: '입어보기',
  ...
  // ── try-on "fits" ──
  fitsLeft: 'fits {n}개 남음',
  fitsBonus: '보너스 +{n}',
  fitsToday: '오늘 {n}개 남음',
  fitsOutTitle: '오늘의 try-on을 다 썼어요',
  fitsOutBody: '오늘 무료 try-on을 다 썼어요. 친구를 초대하면 둘 다 +10 try-on — 아니면 내일 다시 5개가 채워져요.',
  fitsRow: '입어보기 fits',
  inviteFriends: '친구 초대',
  inviteEarnFits: '둘 다 +10 try-on',
  inviteEnterCode: '초대코드 입력',
  inviteFromLink: '초대 링크에서 자동으로 입력했어요',
  inviteCodeLabel: '초대코드',
  inviteCodeApply: '적용',
  inviteYourCode: '내 초대코드',
  inviteRedeemed: '적용됐어요 — 둘 다 +10 try-on을 받았어요!',
  inviteAlreadyRedeemed: '이미 초대코드를 사용했어요.',
  inviteInvalidCode: '유효하지 않은 초대코드예요.',
  inviteSelf: '자기 코드는 쓸 수 없어요.',
  inviteShareCode: 'drape 받고 내 코드 {code} 입력하면 우리 둘 다 보너스 try-on 10개씩 받아.',
  ...
  ootdSetRep: '대표로 설정',
  ootdRepActive: '대표 사진',
  ootdPublishLabel: '공개하기',
  ootdPublishHint: '공개한 룩은 트렌드의 커뮤니티 픽으로 소개될 수 있어요.',
  ootdNotFound: '이 OOTD 는 볼 수 없어요.',
  confirmDeleteGeneration: '이 가상 피팅 결과를 삭제할까요?',
  notifications: '알림',
  notifEmpty: '아직 알림이 없어요.',
  notifCommentedLook: '님이 내 룩에 댓글을 남겼어요',
  notifCommentedBoard: '님이 내 보드에 댓글을 남겼어요',
  notifFollowed: '님이 나를 팔로우했어요',
  notifTriedOn: '님이 내 룩을 입어봤어요',
  notifLikedLook: '님이 내 룩을 좋아해요',
  notifLikedBoard: '님이 내 보드를 좋아해요',
  notifModeration: '이미지가 부적합으로 판단되어 룩 공개가 해제됐어요.',
  followers: '팔로워',
  following: '팔로잉',
  ...
  verdictPaidNote: '오늘 무료를 다 썼어요 — 다음부터는 트라이온 1개로 10회예요.',
  verdictLeft: '트라이온 1개를 썼어요 — {n}회 남았어요.',
  verdictSignIn: '로그인하면 스타일리스트에게 물어볼 수 있어요.',
  ...
  homeScreenTrends: '트렌드',
  homeScreenProfileHint: '앱을 열면 내 옷장·캘린더·트라이온으로 시작해요.',
  homeScreenTrendsHint: '앱을 열면 트렌드로 시작해요 — 이번 주 스타일·컬러·브랜드를 봐요.',
  ...
  tryThisOn: '입어보기',
  originWishlist: '위시리스트',
  originBorrowed: '다른 사람 아이템에서 담음',
  borrowedToWishlist: '입어보려고 위시리스트에 담았어요',
  triedOnCount: '{count}명이 입어봤어요',
  editTags: '편집',
  reprocess: '다시 처리',
  ...
  onboardSlide2Body: '등록한 내 사진으로 어떤 옷이든 입혀볼 수 있어요. 직접 입어보지 않아도 나한테 어울리는지, 어디에 입고 가면 좋을지 미리 보세요. 진짜 내 얼굴·체형 그대로라 결과도 자연스러워요. 하루 5번 무료로 입어볼 수 있고, 친구를 초대하면 더 받아요.',
  ...
  stylistTitle: '스타일리스트',
  stylistAiNote: 'AI',
  stylistSignInBody: '로그인하면 내 옷장에 있는 옷들로 스타일리스트가 룩을 만들어줘요.',
  personaNoaTag: '미니멀 & 타임리스',
  personaRemyTag: '스트리트 & 릴랙스드',
  personaSolTag: '로맨틱 & 소프트',
  personaJunoTag: '볼드 & 플레이풀',
  personaNoaBio: '좋은 무채색 한 벌을 중심에 두고 나머지는 비켜서게 합니다.',
  personaRemyBio: '신발부터 정하고 위로 쌓아 올려요. 튀는 건 한 벌에 딱 하나.',
  personaSolBio: '천이 어떻게 움직이는지, 아무도 신경 안 쓰는 디테일을 봐요.',
  personaJunoBio: '당신이 안 꺼내던 옷을 찾아내서 그걸 주인공으로 만듭니다.',
  stylistAskPlaceholder: '상황이나 무드 (선택) — “데이트룩”, “비 오는 날”…',
  ...
  stylistPaidNote: '무료 추천을 다 썼어요 — 트라이온 1개로 3회 더 받을 수 있어요. {fits}개 있어요.',
  stylistNoFits: '오늘 무료 추천과 트라이온을 모두 썼어요 — 친구를 초대하면 둘 다 +10회, 아니면 내일 다시 채워져요.',
  ...
  trendsIssue: '{date} 호 · {from}–{to} 기록 · 매주 월요일 발행',
  trendsLooks: '이번 호의 룩',
  trendsLooksNote: '앱에 공개된 룩 중에서 drape가 골랐어요.',
  trendsBrands: '많이 가진 브랜드',
  trendsNew: 'NEW',
  trendsAddedThisWeek: '{n}개 등록',
  trendsInClosets: '옷장에 {n}개',
  trendsTopStyles: '뜨는 스타일',
  trendsTopColors: '요즘 입는 색',
  trendsTriedOn: '많이 입어본 카테고리',
  trendsMarket: '마켓 새 상품',
  trendsEmpty: '트렌드가 쌓이는 중이에요 — 아이템을 등록하고 입어보면 이 보드가 채워져요.',
  tourTitle: 'drape 둘러보기',
  tourTrends: '트렌드는 첫 화면이에요 — 이번 주 뜨는 스타일·색·브랜드를 매주 월요일 새 이슈로 보여줘요.',
  tourProfileNav: '이 버튼이 내 옷장이에요. 가진 옷, 캘린더, 트라이온이 전부 여기 있어요.',
  tourTabs: '옷장은 이 탭들로 나뉘어요 — 코디, 캘린더, 옷장, 보드, 트라이온.',
  tourCreate: '여기서 시작해요. 옷을 찍으면 배경을 잘라내고 태그까지 붙여줘요. 몇 벌만 넣으면 나머지가 다 돌아가요.',
  ...
  tourTryon: '트라이온이 drape의 핵심이에요. 내 사진 위에 옷을 입혀봐요. 얼굴과 몸은 그대로, 매일 5번 무료예요.',
  homeFlipNote: '설정에서 언제든 바꿀 수 있어요.',
  myStyleTitle: '내 스타일',
  myStyleHint: '여기 적은 내용이 추측보다 우선해요. 다음 추천부터 바로 반영됩니다.',
  myStyleLiked: '좋아하는 스타일',
  myStyleAvoid: '피하고 싶은 색',
  myStyleNote: '그 외 메모',
  myStyleNotePlaceholder: '“크롭은 안 입어요”, “하이웨스트만”, “추위 많이 타요”…',
  importTitle: '링크에서 가져오기',
  ...
  hintTryonLook: '이 look, 내 사진에 그대로 입혀볼 수 있어요.',
  ...
  deleteAccountItem_credits: '남은 트라이온 횟수',
