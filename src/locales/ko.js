export const ko = {
  ...
  navTrends: '트렌드',
  trendsTitle: '트렌드',
  trendsSub: '이번 주 drape 옷장들: 아이템 {items}개 등록 · 트라이온 {tryons}회',
  trendsTopStyles: '뜨는 스타일',
  trendsPersonaNote: 'AI 스타일리스트가 소개해요.',
  trendsTopColors: '요즘 입는 색',
  trendsTriedOn: '많이 입어본 카테고리',
  trendsCommunityPicks: '커뮤니티 픽',
  trendsCuratedNote: '공개로 설정된 룩 중에서 저희가 골라 소개해요. 룩을 공개하면 트렌드에 소개될 수 있어요.',
  trendsMarket: '마켓 새 상품',
  trendsRegions: '옷장이 있는 곳',
  trendsEmpty: '트렌드가 쌓이는 중이에요 — 아이템을 등록하고 입어보면 이 보드가 채워져요.',
  myStyleTitle: '내 스타일',
  myStyleHint: '스타일리스트에게 직접 알려주세요 — 여기 적은 내용은 옷장·트라이온에서 추측한 취향보다 항상 우선해요.',
