export const ko = {
  ...
  fitsBonus: '보너스 +{n}',
  fitsToday: '오늘 {n}개 남음',
  fitsOutTitle: 'fits를 다 썼어요',
  fitsOutBody: '지금은 fits를 다 썼어요. 친구를 초대하면 친구당 +10 fits — 아니면 내일 다시 5개가 채워져요.',
  fitsRow: '입어보기 fits',
  inviteFriends: '친구 초대',
  inviteEarnFits: '친구당 +10 fits',
  inviteEnterCode: '초대코드 입력',
  inviteCodeLabel: '초대코드',
  inviteCodeApply: '적용',
  inviteYourCode: '내 초대코드',
  inviteRedeemed: '적용됐어요 — 친구가 +10 fits를 받았어요. 고마워요!',
  inviteAlreadyRedeemed: '이미 초대코드를 사용했어요.',
  inviteInvalidCode: '유효하지 않은 초대코드예요.',
  inviteSelf: '자기 코드는 쓸 수 없어요.',
  inviteShareCode: 'drape 받고 내 코드 {code} 입력하면 보너스 fits 10개 받아.',
