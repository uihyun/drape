...
- **Share-to-drape, native halves (§A) — in repo 2026-09-14, ship with
  ...
  extension (links/text v1, no App Group) — target hand-wired into
  project.pbxproj 2026-09-14 and VERIFIED: xcodebuild lists both targets,
  App-scheme simulator build succeeds with the appex embedded. Zero Xcode
  setup left; archive as usual. Import page now handles native file shares.
